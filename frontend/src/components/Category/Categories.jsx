...
const handleDeleteWithPopup = (itemNumber) => {
    ...
    axios.delete('https://invoice-management-2-wnw6.onrender.com/home/deletecategory/'+id)
        .then( res=> {
            //  navigate('/Dashboard');
            window.location.reload(); 
            toast.warning('Catégorie supprimée avec succès !');
    ...
    <div className="col-xl-12">
        <div className="card mg-b-20">
            <div className="card-header d-flex justify-content-between align-items-center">
                ...
                <Link className="btn btn-secondary d-flex align-items-center justify-content-center rounded-5" to="/Dashboard/Addcategory">Ajouter une catégorie</Link>
            </div>
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <Link
                                            ...
                                            to={`/Dashboard/Modifycategory/${item.id}`}
                                            title="Modifier"
                                        >
